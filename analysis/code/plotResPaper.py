    ...
    for testName in testNames:
        ...
        for filename in filenames:
            ...
            if runIdent not in runs[testName]:
                ...
                runCliNum[testName][runIdent] = int(fid['name'].split('_')[6])
...
testNames = ['Final1-static','Final1-equal','Final1-weighted','Final1-cnsm']
descriptors = ['static','equal','weighted','cnsm']
clients = ['VID', 'LVD', 'FDO', 'VIP', 'SSH']
resToSli = {
    'VID' : 46741,
    'LVD' : 41430, 
